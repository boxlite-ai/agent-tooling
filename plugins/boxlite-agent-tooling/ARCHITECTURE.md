...
- Enforcement scope: Stop checks the final reply after generation; it cannot retract streamed commentary. Shared guidance applies to every human-facing output across these surfaces.
