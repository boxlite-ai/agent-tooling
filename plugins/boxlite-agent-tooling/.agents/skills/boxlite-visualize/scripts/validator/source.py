...
ROOT_KEYS = {"schema_version", "context", "views", "topics", "states", "nodes", "edges", "boundaries", "annotations"}
...
ITEM_KEYS = {"id", "label", "states", "views", "topics", "proposed", "evidence"}
EDGE_KEYS = ITEM_KEYS | {"from", "to", "kind"}
BOUNDARY_KEYS = ITEM_KEYS | {"members", "scope"}
MEMBERSHIP_KEYS = {"target", "states", "topics"}
